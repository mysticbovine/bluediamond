...
<html lang="en">
 <head>
  ...
  <!-- The above 3 meta tags *must* come first in the head; any other head content must come *after* these tags -->
	<meta name="desrciption" content="Blue Diamond Tour will take you on a tour to many parts of Nova Scotia for some of the best seafood.">
	<meta name="keywords" content="Blue Diamond Tours, group tour, Nova Scotia, Halifax,  Cape Breton, seafood, scallops, lobster, oysters">
	<meta name="robots" content="index, follow">
	<meta name="revisit-after" content="15 days">
	<meta name="author" content="Rob Evans alacarde.ca">
  <link rel="icon" href="../favicon.ico">

  <title>Scenic Seafood Trail | Blue Diamond Tours | Nova Scotia</title>
...
================================================== -->
 <body>
	...
	<div class="hero">
		<div class="container">
			<h1 class="page-title">Scenic Seafood Trail  
			<span class="welcome"> <span class="hidden-xs">Customized Tours of Canada's Maritime Province</span></span></h1>
		</div>
		<img src="../../images/headers/seafoodtrail.jpg" alt="Cooked lobsters on a plate." class="img-responsive">
	</div>
		...
		<div class="container" role="top">
		 <div class="row">
			...
			<div class="col-md-12 text-center">
				<p class="lead"> Nova Scotia is a stunning Province and we think it has some of the freshest, tastiest seafood in the world... so we thought we should create a tour with a perfect marriage of scenery and seafood!</p>
