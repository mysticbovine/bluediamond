...
<html lang="en">
  <head>
	...
	<meta name="description" content="Blue Diamond Tours designs sightseeing tours and shore excursions for cruise passengers and private groups wanting to explore Nova Scotia.">
	...
	<link href='https://fonts.googleapis.com/css?family=Open+Sans:400,700,800,400italic,700italic' rel='stylesheet' type='text/css'>
      ...
      <div class="row text-center">
        <div class="col-md-12">
          ...
          <ul class="homepage social">
            <li><a href="https://www.facebook.com/NovaScotiaGuidedTours" class="btn btn-default btn-lg faceboook" target=_blank><img src="images/fb-lg.png">Like us on Facebook</a></li>
            <li><a href="https://twitter.com/NovaScotiaTours" class="btn btn-default btn-lg twitter" target=_blank><img src="images/twitter-lg.png">Follow us on Twitter</a></li>
          </ul>
        </div>
      </div>
    </div>
		...
		<div class="col-md-12">
			<div class="item">
				<div class="videoWrapper">
					<iframe src="https://www.youtube.com/embed/GnGsWKBlj-g" width="500" height="281" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
				</div>
			</div>
		</div>
	</div>
  <div class="container testimonials">
	...
	<div class="container-fluid intro" role="top">
		<div class="container" role="top">
		  <div class="row">
			<div class="col-sm-12">
				<h1 class="text-center">Custom private tours of Nova Scotia, New Brunswick and Prince Edward Island</h1> 
			
				<p class="lead">There is so much to see, do and experience in the Maritimes - let us help you enjoy all there is to offer.   </p>
				
				<p>Each tour is customized to suit your needs, wants and time frame and is accompanied by a knowledgeable guide.</p>
				...
				<h2>Below are samples of tours we have made for people just like you.</h2>
			</div>
			<div class="col-sm-12">
	...
	<div class="hidden-xs hidden-sm">
		<div class="well">
			...
			<ul class="filters">
				...
				<li class="filter mini btn btn-lg btn-primary" data-filter=".halifax">Halifax</li>
		...
		<div class="collapse" id="collapseExample">
		  <div class="well">
			...
			<ul class="filters">
				...
				<li class="filter mini btn btn-primary" data-filter=".halifax">Halifax</li>
...
<script type="text/javascript">
  ...
  <script src="../../js/ie10-viewport-bug-workaround.js" defer></script>
	<script src="https://cdn.jsdelivr.net/jquery.mixitup/latest/jquery.mixitup.min.js" defer></script>
