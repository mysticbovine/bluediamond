		...
		<div class="container">
			<div class="row header-widgets">
				<div class="col-xs-6 hidden-md hidden-sm hidden-xs no-mobile">
					<div class="slogan no-mobile">Private tours of Noava Scotia, New Brunswick and Prince Edward Island</div>
				</div>
        ...
        <div id="navbar" class="navbar-collapse collapse">
          ...
          <ul class="nav navbar-nav">
            ...
            <li class="dropdown<?php if ($page == "tours") { print " active"; }?>">
				<a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">Guided Tours <span class="caret"></span></a>
				<ul class="dropdown-menu" role="menu">
					<li class="hidden"><a href="/novascotiatours/bustours.php">Do we do Bus Tours?</a></li>
            ...
            <li class="hidden"><a href="http://www.halifaxshoreexcursions.com/" target="_blank">Shore Excursions</a></li>
		
                     
            <li <?php if ($page == "blog") { print " class='active'"; }?>><a href="/blog">Hidden Treasures</a></li>   
